...
function AvailableSlots() {
    ...
    const onSubmit = (event) => {
        ...
        // if (slotsDetails?.length == 0) {
            ...
            fetch('http://3.142.208.221:4200/vaccination-center-service/api/v1/slots/create', requestOptions)
                .then((result) => {
    ...
    const onDelete = (event) => {
        ...
        fetch('http://3.142.208.221:4200/vaccination-center-service/api/v1/slots/' + modalSlotData.slotId, requestOptions)
            .then((result) => {
                if (result.status === 200) {
                    setEditOpen(false)
                    getSlotsDetails();
    ...
    const getSlotsDetails = () => {
        return fetch("http://3.142.208.221:4200/vaccination-center-service/api/v1/slots/available/center/" + emailPass, {
            headers: {
