...
function VCProfile() {
    ...
    const getUserData = () => {
        ...
        //let url = "https://spotyourvaccine.stackroute.io/user-service/api/v1/vaccination-center/"+email;
        let url = "http://3.142.208.221:4200/user-service/api/v1/vaccination-center/"+email;
